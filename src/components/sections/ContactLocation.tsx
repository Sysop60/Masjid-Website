              ...
              <div>
                ...
                <div className="mt-6 space-y-3 text-sm">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <a aria-label="YouTube" href="https://www.youtube.com/@MesjidAbdelkarimAlKhattabi" className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/40 backdrop-blur-sm ring-1 ring-white/50 border border-primary/5 hover:bg-white/60 transition-colors shadow-sm">
